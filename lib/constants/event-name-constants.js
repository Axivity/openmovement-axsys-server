...
export const AX_DEVICE_ATTRIBUTE_PUBLISH = 'ax-device-attribute-publish';
...
export const AX_ATTRIBUTE_CACHE_PUBLISH = 'ax-attribute-cache-publish';

export const AX_CREATE_PROCESS = 'ax-create-process';

export const AX_CLIENT_FILES_GET_ALL = 'ax-files:getAll';