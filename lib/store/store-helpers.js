...
export function observeStore(store, select, onChange) {
    ...
    function handleChange() {
        ...
        if (nextState !== currentState) {
            ...
            // NB: The following call to buildChangesListTillLastParentNode is
            ...
            let changesAtNodeThatAreNotLeaf = buildChangesListTillLastParentNode(changes, currentState);
 ...
 * @returns {List<Map>}
 */
export function buildChangesListTillLastParentNode(detectedChanges,
