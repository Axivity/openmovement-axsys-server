    ...
    openPath (callback) {
        ...
        this.conn.open((err) => {
            if(err) {
                ...
                // NB: This listener has no idea about which command
                //     triggered this incoming data. Hence it's the responsibility
                //     of the app that listens to this event to map
